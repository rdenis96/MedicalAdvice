...
var id31 = function(_s,target,features){
    ...
    node.type = "feature";
    node.vals = _.map(possibleValues,function(v){ if(v==1){console.log("found sth");} else { return {type:"result", val: "", name: "",alias:"" };}
        ...
        child_node.child =  id31(_newS,target,remainingFeatures);
        return child_node;
